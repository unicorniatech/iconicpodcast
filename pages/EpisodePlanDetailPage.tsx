      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 bg-white rounded-2xl shadow-md border border-gray-200 p-4">
            ...
            <select
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white text-gray-900 mb-3"
              value={plan.guest_id || ''}
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-md border border-gray-200 p-4 space-y-4">
            <div>
              <div className="text-xs uppercase text-gray-400 mb-1">{t.outline}</div>
              <textarea
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm resize-none bg-white text-gray-900 min-h-[120px]"
                value={plan.outline || ''}
            ...
            <div>
              <div className="text-xs uppercase text-gray-400 mb-1">{t.resources}</div>
              <textarea
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm resize-none bg-white text-gray-900 min-h-[100px]"
            ...
            <div>
              <div className="text-xs uppercase text-gray-400 mb-1">{t.notes}</div>
              <textarea
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm resize-none bg-white text-gray-900 min-h-[100px]"
                value={plan.notes || ''}
