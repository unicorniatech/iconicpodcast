  ...
  return (
    <div className="relative bg-iconic-black min-h-screen flex items-start md:items-center pt-32 sm:pt-40 pb-12 overflow-hidden z-10">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-600/30 via-transparent to-transparent animate-pulse" style={{animationDelay: '1s'}}></div>
      </div>
      ...
      <div className="absolute top-1/2 left-1/2 w-[300px] h-[300px] bg-fuchsia-600/20 rounded-full blur-[100px] animate-blob animation-delay-4000"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 h-full items-center">
            <div className={`flex flex-col justify-center text-center lg:text-left order-2 lg:order-1 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold mb-6 leading-[1.1] transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
                    ...
                    <span className="bg-gradient-to-r from-iconic-pink via-fuchsia-500 to-purple-500 bg-clip-text text-transparent animate-gradient-slow bg-[length:200%_auto]">
